...
public class ConversorDivisas {
    ...
    private static final String API_KEY = "fc8c6ee56ad61d32565d4727"; // Mi API Key
    ...
    // Metodos para convertir las Monedas
    ...
    static void convertirBRLToUSD(Scanner scanner) throws IOException {
        ...
        System.out.println("Tipo de Cambio del Dolar "+tipoCambioUSD);
